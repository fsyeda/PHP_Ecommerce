...
<div class="container">
    ...
    <ul class="nav nav-pills nav-justified">
      ...
      <li role="presentation"><a href="/products">BEST SELLERS</a></li><li role="presentation"><a href="/products/shopping_cart">Shopping cart (<?= $product['count']['COUNT(product_id)']; ?>)</a></li>
			...
			<div class="right-block">
				...
				<form method="post" action="/products/update_cart/<?= $product['id']; ?>" id="submit">
							<select name="quantity" id="quantity">
								<option name="1" value="1">1 $<?php $price = $product['price'] * 1; echo $price; ?></option>
								<option name="2" value="2">2 $<?php $price = $product['price'] * 2; echo $price; ?></option>
								<option name="3" value="3">3 $<?php $price = $product['price'] * 3; echo $price; ?></option>
								<option name="4" value="4">4 $<?php $price = $product['price'] * 4; echo $price; ?></option>
								<option name="5" value="5">5 $<?php $price = $product['price'] * 5; echo $price; ?></option>
							</select>
